...
public class SecretFloor : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        rightBoundary_ = (GameObject)Instantiate(m_PlanePrefab, new Vector3(floorRenderer_.bounds.max.x, 0.0f, floorRenderer_.transform.position.z), Quaternion.identity);
