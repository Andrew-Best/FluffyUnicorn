...
public class FloorBoundary : MonoBehaviour 
{
	...
	void Start () 
    {
        ...
        leftBoundary_.transform.localScale = new Vector3(leftBoundary_.transform.localScale.x, leftBoundary_.transform.localScale.y, (floorRenderer_.bounds.size.z / 10));
        ...
        rightBoundary_.transform.localScale = new Vector3(rightBoundary_.transform.localScale.x, rightBoundary_.transform.localScale.y, (floorRenderer_.bounds.size.z / 10));
        ...
        frontBoundary_.transform.localScale = new Vector3(frontBoundary_.transform.localScale.x, frontBoundary_.transform.localScale.y, (floorRenderer_.bounds.size.x / 10));
        ...
        backBoundary_.transform.localScale = new Vector3(backBoundary_.transform.localScale.x, backBoundary_.transform.localScale.y, (floorRenderer_.bounds.size.x / 10));
